...
class ComputeNodeRuntimeTests(unittest.TestCase):
    ...
    def test_run_registers_records_heartbeat_and_executes_task(
        ...
        load_compute_performance_summary_mock.return_value = inventory.to_legacy_summary()
    ...
    def test_run_reports_registration_failure(
        ...
        load_compute_performance_summary_mock.return_value = load_runtime_processor_inventory_mock.return_value.to_legacy_summary()
