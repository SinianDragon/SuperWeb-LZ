...
class PerformanceMatricsTests(unittest.TestCase):
    ...
    def test_write_float32_file_parallelizes_even_when_one_chunk_would_cover_the_file(self) -> None:
        with tempfile.TemporaryDirectory(dir=PROJECT_ROOT) as temp_dir, mock.patch.object(
    ...
    def test_parallel_generate_dataset_matches_single_process_bytes(self) -> None:
        ...
        with tempfile.TemporaryDirectory(dir=PROJECT_ROOT) as sequential_dir, tempfile.TemporaryDirectory(dir=PROJECT_ROOT) as parallel_dir:
    ...
    def test_benchmark_auto_generates_and_runs_cpu(self) -> None:
        ...
        with tempfile.TemporaryDirectory(dir=PROJECT_ROOT) as temp_dir, mock.patch(
