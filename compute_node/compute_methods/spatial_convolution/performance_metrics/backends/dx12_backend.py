...
DX12_DIR = ROOT_DIR / "conv2d_runners" / "dx12"
...
class Dx12Backend:
    ...
    def _run_runner(
        ...
        *,
        ...
        try:
            ...
            emit_status(
                "method.spatial_convolution.backend.native_runner.timeout",
                status="failed",
                method="spatial_convolution",
                backend=self.name,
                phase=phase,
            ...
            emit_status(
                "method.spatial_convolution.backend.native_runner.error",
                status="failed",
                method="spatial_convolution",
                backend=self.name,
                phase=phase,
    ...
    def _compile_runner(self) -> None:
        ...
        compile_script_path = DX12_BUILD_DIR / "build_spatial_dx12_runner.cmd"
